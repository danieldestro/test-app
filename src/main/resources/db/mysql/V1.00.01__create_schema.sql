...
create table country (id int auto_increment not null, name varchar(255), primary key (id));
create table proposal (id int auto_increment not null, name varchar(255), primary key (id));
create table service (id int auto_increment not null, name varchar(255), proposal_id int, months int not null, primary key (id));
...
create table srv_price_breakdown (id int auto_increment not null, country_id int not null, srv_price_summary_id int, primary key (id));
